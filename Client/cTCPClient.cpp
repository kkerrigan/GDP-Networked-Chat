...
*/
bool cTCPClient::resolveServerAddr() {
...
*	Returns: None
*/
void cTCPClient::startListen() {
	
	int result = 0;
	cClientMessageHandler* handler = cClientMessageHandler::getInstance();
...
*/
bool cTCPClient::sendMessage(cBuffer messageBuffer) {
...
*/
bool cTCPClient::closeSendSocket() {
